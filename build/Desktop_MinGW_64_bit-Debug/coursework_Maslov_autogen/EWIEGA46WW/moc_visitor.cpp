...
Q_CONSTINIT static const qt_meta_stringdata_CLASSVisitorENDCLASS_t qt_meta_stringdata_CLASSVisitorENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(35, 11),  // "visitorText"
        QT_MOC_LITERAL(47, 4),  // "text"
        QT_MOC_LITERAL(52, 11),  // "pressButton"
        QT_MOC_LITERAL(64, 8)   // "sendText"
    },
    "Visitor",
    "buttonPressed",
    "",
...
void Visitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->visitorText((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->pressButton((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        ...
        {
            using _t = void (Visitor::*)(const QString & );
            if (_t _q_method = &Visitor::visitorText; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Visitor::visitorText(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };

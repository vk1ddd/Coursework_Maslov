...
public:
    ...
    QWidget *dialogContainerIntercom;
    ...
    QPushButton *btnBack;
    QWidget *dialogContainerApt;
    QLineEdit *lineEditSendApt;
    QLabel *labelReceiveApt;
    QPushButton *btnSendApt;
...
""));
        ...
        dialogContainerIntercom = new QWidget(tabIntercom);
        dialogContainerIntercom->setObjectName("dialogContainerIntercom");
        dialogContainerIntercom->setGeometry(QRect(10, 150, 191, 261));
        dialogContainerIntercom->setAutoFillBackground(false);
        dialogContainerIntercom->setStyleSheet(QString::fromUtf8("background-color: rgb(85, 79, 48);\n"
"border-color: rgb(0, 0, 0);"));
        lineEditSendIntercom = new QLineEdit(dialogContainerIntercom);
        lineEditSendIntercom->setObjectName("lineEditSendIntercom");
        lineEditSendIntercom->setGeometry(QRect(0, 100, 191, 111));
        QFont font2;
        font2.setFamilies({QString::fromUtf8("Unispace")});
        font2.setPointSize(14);
        font2.setBold(true);
        lineEditSendIntercom->setFont(font2);
        lineEditSendIntercom->setAlignment(Qt::AlignCenter);
        labelReceiveIntercom = new QLabel(dialogContainerIntercom);
        labelReceiveIntercom->setObjectName("labelReceiveIntercom");
        labelReceiveIntercom->setGeometry(QRect(0, 10, 191, 81));
        labelReceiveIntercom->setFont(font2);
        labelReceiveIntercom->setAutoFillBackground(false);
        labelReceiveIntercom->setTextFormat(Qt::PlainText);
        labelReceiveIntercom->setAlignment(Qt::AlignCenter);
        btnSendIntercom = new QPushButton(dialogContainerIntercom);
...
"}"));
        ...
        dialogContainerApt = new QWidget(handset);
        dialogContainerApt->setObjectName("dialogContainerApt");
        dialogContainerApt->setGeometry(QRect(310, 160, 191, 271));
        dialogContainerApt->setStyleSheet(QString::fromUtf8("background-color: rgb(207, 171, 115);"));
        lineEditSendApt = new QLineEdit(dialogContainerApt);
        lineEditSendApt->setObjectName("lineEditSendApt");
        lineEditSendApt->setGeometry(QRect(0, 100, 191, 111));
        lineEditSendApt->setFont(font2);
        lineEditSendApt->setAlignment(Qt::AlignCenter);
        labelReceiveApt = new QLabel(dialogContainerApt);
        labelReceiveApt->setObjectName("labelReceiveApt");
        labelReceiveApt->setGeometry(QRect(0, 10, 191, 81));
        labelReceiveApt->setFont(font2);
        labelReceiveApt->setAlignment(Qt::AlignCenter);
        btnSendApt = new QPushButton(dialogContainerApt);
        btnSendApt->setObjectName("btnSendApt");
        btnSendApt->setGeometry(QRect(50, 230, 80, 24));
        btnSendApt->setStyleSheet(QString::fromUtf8("background-color: rgb(59, 43, 26);"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelReceiveApt->setText(QString());
        btnSendApt->setText(QCoreApplication::translate("MainWindow", "\320\236\321\202\320\277\321\200\320\260\320\262\320\270\321\202\321\214", nullptr));
